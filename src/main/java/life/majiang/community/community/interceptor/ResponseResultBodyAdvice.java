...
import life.majiang.community.community.model.ResultException;
...
public class ResponseResultBodyAdvice implements ResponseBodyAdvice<Object> {
     ...
     */
    @Override
    public boolean supports(MethodParameter returnType, Class<? extends HttpMessageConverter<?>> converType) {
...
//==============================================异常处理,但是没有生效，被community原先的异常处理拦截了=========================================================
    /**
