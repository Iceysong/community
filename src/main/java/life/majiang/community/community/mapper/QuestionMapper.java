...
public interface QuestionMapper {
    ...
    @Update("update question set title=#{title},description=#{description},gmt_modified=#{gmtModified},creator=#{creator}," +
            "comment_count=#{commentCount},view_count=#{viewCount},like_count=#{likeCount},tag=#{tag} where id=#{id}")
